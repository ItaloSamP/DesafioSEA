...
/**
 * Alterna o status de uma subtarefa (pendente ↔ concluída).
...
@Component(
    ...
    property = {
        ...
        "mvc.command.name=/todolist/toggle_subtask"
    },
    service = MVCActionCommand.class
)
public class ToggleSubtaskMVCActionCommand extends BaseMVCActionCommand {
    ...
    protected void doProcessAction(
        ...
        // Busca a subtarefa para confirmar que pertence à task informada
        ...
        SubtaskLocalServiceUtil.toggleSubtaskStatus(subtaskId);

        SessionMessages.add(actionRequest, "subtask-toggled");
