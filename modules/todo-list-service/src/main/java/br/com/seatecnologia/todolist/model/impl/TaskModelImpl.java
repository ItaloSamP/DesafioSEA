...
import br.com.seatecnologia.todolist.model.TaskModel;
...
/**
 * The base model implementation for the Task service. Represents a row in the &quot;SEA_Task&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	 ...
	 */
	public static final String TABLE_NAME = "SEA_Task";
	...
	public static final String ORDER_BY_JPQL =
		" ORDER BY task.dueDate ASC, task.createDate ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY SEA_Task.dueDate ASC, SEA_Task.createDate ASC";
	 ...
	 */
	@Deprecated
	public static final long ISDELETED_COLUMN_BITMASK = 4L;
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("isCompleted", Task::getIsCompleted);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"isCompleted", (BiConsumer<Task, Boolean>)Task::setIsCompleted);
			attributeSetterBiConsumers.put(
				"isDeleted", (BiConsumer<Task, Boolean>)Task::setIsDeleted);
			attributeSetterBiConsumers.put(
	 ...
	 */
	@Deprecated
	public boolean getOriginalIsDeleted() {
	...
	public Object clone() {
		...
		taskImpl.setIsCompleted(isIsCompleted());
	...
	public CacheModel<Task> toCacheModel() {
		...
		taskCacheModel.isCompleted = isIsCompleted();

		taskCacheModel.isDeleted = isIsDeleted();
	...
	static {
		...
		columnBitmasks.put("isCompleted", 1024L);

		columnBitmasks.put("isDeleted", 2048L);
