...
import br.com.seatecnologia.todolist.service.persistence.CategoryUtil;
...
public class CategoryPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByUserCategories;
	private FinderPath _finderPathWithoutPaginationFindByUserCategories;
	private FinderPath _finderPathCountByUserCategories;
	 ...
	 */
	@Override
	public List<Category> findByUserCategories(long groupId, long userId) {
		return findByUserCategories(
	 ...
	 */
	@Override
	public List<Category> findByUserCategories(
		long groupId, long userId, int start, int end) {

		return findByUserCategories(groupId, userId, start, end, null);
	}
	...
	public List<Category> findByUserCategories(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByUserCategories;
				finderArgs = new Object[] {groupId, userId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByUserCategories;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_USERCATEGORIES_GROUPID_2);

			sb.append(_FINDER_COLUMN_USERCATEGORIES_USERID_2);
	...
	public Category findByUserCategories_First(
		...
		Category category = fetchByUserCategories_First(
	...
	public Category fetchByUserCategories_First(
		...
		List<Category> list = findByUserCategories(
	...
	public Category findByUserCategories_Last(
		...
		Category category = fetchByUserCategories_Last(
			groupId, userId, orderByComparator);
	...
	public Category fetchByUserCategories_Last(
		...
		int count = countByUserCategories(groupId, userId);
	...
	public Category[] findByUserCategories_PrevAndNext(
		...
		try {
			...
			array[0] = getByUserCategories_PrevAndNext(
				session, category, groupId, userId, orderByComparator, true);

			array[1] = category;

			array[2] = getByUserCategories_PrevAndNext(
				session, category, groupId, userId, orderByComparator, false);
	...
	protected Category getByUserCategories_PrevAndNext(
		Session session, Category category, long groupId, long userId,
		OrderByComparator<Category> orderByComparator, boolean previous) {
	...
	public int countByUserCategories(long groupId, long userId) {
		FinderPath finderPath = _finderPathCountByUserCategories;
	...
	private static final String _FINDER_COLUMN_USERCATEGORIES_GROUPID_2 =
		"category.groupId = ? AND ";

	private static final String _FINDER_COLUMN_USERCATEGORIES_USERID_2 =
		"category.userId = ?";
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByUserCategories = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByUserCategories",
			new String[] {
		...
		_finderPathWithoutPaginationFindByUserCategories = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUserCategories",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"groupId", "userId"}, true);

		_finderPathCountByUserCategories = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUserCategories",
			new String[] {Long.class.getName(), Long.class.getName()},
