...
/**
 * The table class for the &quot;SEA_Task&quot; database table.
 *
 * @author Carlos
 * @see Task
 * @generated
...
public class TaskTable extends BaseTable<TaskTable> {
	...
	public final Column<TaskTable, Boolean> isCompleted = createColumn(
		"isCompleted", Boolean.class, Types.BOOLEAN, Column.FLAG_DEFAULT);
	public final Column<TaskTable, Boolean> isDeleted = createColumn(
		"isDeleted", Boolean.class, Types.BOOLEAN, Column.FLAG_DEFAULT);
