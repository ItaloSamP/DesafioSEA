...
/**
 * The persistence utility for the comment service. This utility wraps <code>br.com.seatecnologia.todolist.service.persistence.impl.CommentPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CommentUtil {
	...
	public static Comment findByUuid_First(
		...
		throws br.com.seatecnologia.todolist.exception.NoSuchCommentException {
	 ...
	 * @return the matching comments
	 */
	public static List<Comment> findByTaskComments(long taskId) {
		return getPersistence().findByTaskComments(taskId);
	}
	 ...
	 * @return the range of matching comments
	 */
	public static List<Comment> findByTaskComments(
		long taskId, int start, int end) {

		return getPersistence().findByTaskComments(taskId, start, end);
	}
	...
	public static List<Comment> findByTaskComments(
		...
		return getPersistence().findByTaskComments(
	 ...
	 * @throws NoSuchCommentException if a matching comment could not be found
	 */
	public static Comment findByTaskComments_First(
			long taskId, OrderByComparator<Comment> orderByComparator)
		throws br.com.seatecnologia.todolist.exception.NoSuchCommentException {

		return getPersistence().findByTaskComments_First(
	 ...
	 * @return the first matching comment, or <code>null</code> if a matching comment could not be found
	 */
	public static Comment fetchByTaskComments_First(
		long taskId, OrderByComparator<Comment> orderByComparator) {

		return getPersistence().fetchByTaskComments_First(
			taskId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCommentException if a matching comment could not be found
	 */
	public static Comment findByTaskComments_Last(
			long taskId, OrderByComparator<Comment> orderByComparator)
		throws br.com.seatecnologia.todolist.exception.NoSuchCommentException {

		return getPersistence().findByTaskComments_Last(
			taskId, orderByComparator);
	}
	 ...
	 * @return the last matching comment, or <code>null</code> if a matching comment could not be found
	 */
	public static Comment fetchByTaskComments_Last(
		long taskId, OrderByComparator<Comment> orderByComparator) {

		return getPersistence().fetchByTaskComments_Last(
			taskId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCommentException if a comment with the primary key could not be found
	 */
	public static Comment[] findByTaskComments_PrevAndNext(
			long commentId, long taskId,
			OrderByComparator<Comment> orderByComparator)
		throws br.com.seatecnologia.todolist.exception.NoSuchCommentException {

		return getPersistence().findByTaskComments_PrevAndNext(
			commentId, taskId, orderByComparator);
	}
	 ...
	 * @param taskId the task ID
	 */
	public static void removeByTaskComments(long taskId) {
		getPersistence().removeByTaskComments(taskId);
	}
	 ...
	 * @return the number of matching comments
	 */
	public static int countByTaskComments(long taskId) {
		return getPersistence().countByTaskComments(taskId);
	}
