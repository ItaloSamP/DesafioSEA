 ...
 * <code>br.com.seatecnologia.todolist.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>br.com.seatecnologia.todolist.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static List<Task> getActiveTasksByUserId(long groupId, long userId) {
		return getService().getActiveTasksByUserId(groupId, userId);
	}
	 ...
	 */
	public static List<Task> getHistoryTasksByUserId(
		long groupId, long userId) {

		return getService().getHistoryTasksByUserId(groupId, userId);
	}
	 ...
	 */
	public static Task softDeleteTask(long taskId) throws PortalException {
		return getService().softDeleteTask(taskId);
	}
